...
async def extract_pdf_text(pdf_path: str, output_dir: str):
    ...
    for page_num in range(len(doc)):
        ...
        # Kiểm tra lỗi: Trang rỗng hoặc lỗi encoding/ký tự lạ
    ...
    # Khi PyMuPDF thất bại -> Fallback dùng LlamaParse OCR
    if ocr_used:
    ...
    # Lưu dữ liệu raw đã trích xuất vào folder output
...
async def main():
    ...
    pdf_path = os.path.join(os.path.dirname(__file__), "..", "datademo", "van_ban_mau.pdf")
